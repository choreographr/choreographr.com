+++
title = "Documentation"
description = "Everything you need to install, configure, and use Choreographr."
sort_by = "weight"
weight = 1
+++

Welcome to the Choreographr documentation. Start with the [installation](@/agent/docs/installation.md)
guide, then the [quick start](@/agent/docs/quick-start.md), or jump straight to a topic:
