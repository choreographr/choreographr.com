...
stored in the `redb` database. See [Security](@/agent/docs/security.md) for details.

## Slash command reference

See the [Slash commands](@/agent/docs/slash-commands.md) page for the full list of
