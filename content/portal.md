+++
title = "Portal"
description = "The Choreographr Portal: buy USD credits with CHOR and spend them on inference, IPFS pinning, and the Acuity Index — or commit CHOR for a standing allowance. Non-custodial, one balance."
...
2. Commit CHOR for a standing allowance (own your capacity). Commit CHOR in
   ...
   fixed, platform-backed grant, not a yield from consensus staking, and it is
