...
The purpose of [Acuity Index](/content/) is to provide decentralized indexing for dapps, starting with event log indexing for Polkadot blockchains.

## Quick Start

The Acuity blockchain can be accessed at [chains.acuity.network](/content/)
