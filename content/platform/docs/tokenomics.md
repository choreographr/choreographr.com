...
The first Acuity parachain is ACU. It is for account profile, structured content (like a book) and feed-based content (like X, YouTube, RSS). The block explorer is at <a href="/platform/">chains.acuity.network</a>.
